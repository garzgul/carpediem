...
<div id="footersite">      
    <div id="footer-wrap">
         ...
         <div id="footer-wrap-social">
                <ul>
                    <li>
                        <img id="twitter" title="Twitter" alt="logo twitter" src="./images/twitterlogo.png" width="50" height="50" />
                    </li>
                    <li>
                        <img id="facebook" title="Facebook" alt="logo facebook" src="./images/facebooklogo.png" width="50" height="50" />
                    </li>
                </ul>
